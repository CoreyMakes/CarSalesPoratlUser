<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="UserWebsite.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <ItemTemplate>
                ...
                <div class="col-md-4 text-center col-sm-6 col-xs-6">
                    <div class="thumbnail product-box">
                        ...
                        <div class="caption">
                            <h3><a href="#"><%# Eval("SUBMODEL_NAME") %> </a></h3>
                            ...
                            <asp:Button ID="Button1" CssClass="btn btn-primary" CommandName='<%# Eval("SUBMODEL_ID") %>' runat="server" Text="VIEW DETAILS" OnClick="Button1_Click" />
                        </div>
                    </div>
                </div>
    ...
    <div >
        <iframe width="820" height="315" runat="server" id="videoplayer"></iframe>
    </div>
</asp:Content>
